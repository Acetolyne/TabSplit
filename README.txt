...
ADDITIONAL INFO:
The extension will open as many windows as you have tabs on startup. 

To change which screen the tab opens on, change the order of homepages on the Chrome settings page.

If you have more tabs set to open than you have screens then the extra tabs will open on the last monitor in a stacked fashion. 

The first window must be opened on the monitor furthers to the left. The extension opens additional windows to the right from the first opened window. To make sure it opens on the left most monitor simply make sure the last window you close is on that monitor.
